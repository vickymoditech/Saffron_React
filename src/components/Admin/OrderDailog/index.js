                        ...
                        <div className="modal-content">
                            <div className="modal-body">
                                <div style={{"width": "100%"}} className="main_box">
                                    ...
                                    <div className="d-flex total_price px-4 justify-content-end my-2"><span className="totalTag">Total</span><span className="priceTag">{this.state.order.total}</span></div>
