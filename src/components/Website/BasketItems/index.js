                                ...
                                <div className="d-flex flex-column order_confirm_box">
                                    {this.props.BasketGeneratorProducts.length > 0 && <Collapse accordion>
                                        {this.props.BasketGeneratorProducts.map((singleProduct, index) => (
                                            <Panel header={<div className="orders d-flex justify-content-between align-items-center m-sm-2 p-2">
                                                <ImageLoader
...
<div className="d-flex justify-content-center align-items-center">
                                                <ImageLoader
                                                    ...
                                                    <img className="img-fluid" alt={singleProduct.teamMember.first_name} style={{height:'50px',width:'50px',borderRadius:'50%'}}/>
                                                    <img src="/assets/Images/NoImages.png" className="img-fluid"
                                                         alt={singleProduct.teamMember.first_name}/>
                                                    <img src="/assets/Images/s_loader.gif" className="img-fluid"
                                                         alt={singleProduct.teamMember.first_name}/>
                                                </ImageLoader>
                                                <p style={{textTransform: "capitalize",marginLeft:'10px'}}>{singleProduct.teamMember.first_name + " " + singleProduct.teamMember.last_name}</p>
</div>
                                            </Panel>
                                        ))}
                                    </Collapse>}
                        ...
                        <div className="second_part d-flex flex-sm-nowrap flex-wrap justify-content-between px-2 py-2 w-100">
