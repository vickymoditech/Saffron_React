...
class TeamListModel extends Component {
    ...
    SelectTeamMember = (team) => {
        this.setState({selectedItem: team.id}, () => {
                                ...
                                <div className="product">
                                    ...
                                    <div className="products p-2">
                                        {this.props.TeamList.map((team, index) => (
                                            <div
                                                className={this.state.selectedItem === team.id ? "product-select d-flex align-items-center p-2" : "product_details d-flex align-items-center p-2"}
